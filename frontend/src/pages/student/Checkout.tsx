...
import { ArrowLeft, Banknote, Check, Clock3, CreditCard, Smartphone, Store } from 'lucide-react';
import {
  Button,
  Card,
  Field,
...
export default function Checkout() {
  ...
  // A cart can be emptied in another tab; do not render a checkout for nothing.
  ...
  function submit(e: React.FormEvent) {
    ...
    setPlacing(true);
    // Brief delay so the paying state is visible, as it would be for real.
    setTimeout(() => {
  ...
  return (
    <div className="max-w-[1180px] mx-auto px-4 sm:px-6 py-5">
      ...
      <form onSubmit={submit} noValidate className="grid gap-5 lg:grid-cols-[1fr_360px] items-start">
        {/* ------------------------------------------------------ left column */}
          ...
          {branch && (
            <Card className="p-5">
              ...
              <div className="flex items-start gap-2.5 mt-3 text-[12.5px] text-[var(--color-ink-muted)] leading-relaxed">
                ...
                <span>
                  Collect from <strong className="font-medium text-[var(--color-charcoal)]">
                    {branch.pickupPoint}
                  </strong>
              ...
              {PAYMENT_METHODS.map((m) => (
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-[14px] font-medium text-[var(--color-charcoal)]">
                      {m.label}
                    </span>
                  ...
                  <span
                    ...
                    className={cx(
                      ...
                      method === m.value
                        ? 'border-[var(--color-saffron-deep)] bg-[var(--color-saffron-deep)]'
          ...
          <Card className="p-5">
            ...
            <label className="flex items-start gap-2.5 mt-4 cursor-pointer">
              <input
                ...
                className="mt-0.5 w-4 h-4 accent-[var(--color-saffron)] shrink-0"
              />
            ...
            <Button type="submit" fullWidth size="lg" className="mt-4" loading={placing}>
              {placing ? 'Placing your order…' : `Place order · ${rupees(totals.total)}`}
            </Button>
          </Card>
        </div>
      </form>
